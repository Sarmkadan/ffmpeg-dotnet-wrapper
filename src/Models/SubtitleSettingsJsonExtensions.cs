...
/// <summary>
/// Provides JSON serialization extensions for <see cref="SubtitleSettings"/>.
/// </summary>
public static class SubtitleSettingsJsonExtensions
{
    /// <summary>
    /// Serializes the specified subtitle settings to a JSON string.
    /// </summary>
    /// <param name="settings">The subtitle settings to serialize.</param>
    /// <param name="indented">

...
public static class FFmpegExceptionJsonExtensions
{
	...
	/// <returns>The deserialized FFmpegException, or <see langword="null"/> if the JSON is <see langword="null"/>, empty, or whitespace.</returns>
	...
	public static FFmpegException? FromJson(string json)
	{
		...
		return string.IsNullOrWhiteSpace(json)
			? null
			: JsonSerializer.Deserialize<FFmpegException>(json, _jsonOptions);
	}

...
public static class ThumbnailServiceExtensions
{
    ...
    /// </summary>
    /// <param name="service">The thumbnail service instance.</param>
    ...
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    /// <returns>A <see cref="ThumbnailResult"/> containing the extracted image path.</returns>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when percentage is outside 0-100 range.</exception>

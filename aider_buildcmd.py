...
convenient shortcuts:
    ...
    python3 aider_buildcmd.py test   # runs `dotnet test`
    python3 aider_buildcmd.py build  # runs `dotnet build`
    python3 aider_buildcmd.py clean  # runs `dotnet clean`
    python3 aider_buildcmd.py <any other command>
